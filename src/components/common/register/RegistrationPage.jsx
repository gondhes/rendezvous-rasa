...
const SaveIcon = () => (
  ...
  >
    <path
      d="M15.8333 5.41667L8.74999 12.5L5.41666 9.16667"
      stroke="#4A5568"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M17.5 10C17.5 14.1425 14.1425 17.5 10 17.5C5.8575 17.5 2.5 14.1425 2.5 10C2.5 5.8575 5.8575 2.5 10 2.5"
      stroke="#4A5568"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const EditIcon = () => (
  ...
  >
    <path
      d="M9.94355 3.2L3.78605 9.7175C3.55355 9.965 3.32855 10.4525 3.28355 10.79L3.00605 13.22C2.90855 14.0975 3.53855 14.6975 4.40855 14.5475L6.82355 14.135C7.16105 14.075 7.63355 13.8275 7.86605 13.5725L14.0235 7.055C15.0885 5.93 15.5685 4.6475 13.911 3.08C12.261 1.5275 11.0085 2.075 9.94355 3.2Z"
      stroke="#3558A2"
      stroke-width="1.125"
    ...
    />
    <path
      d="M8.91797 4.28751C9.24047 6.35751 10.9205 7.94001 13.0055 8.15001"
      stroke="#3558A2"
      stroke-width="1.125"
      stroke-miterlimit="10"
      stroke-linecap="round"
...
const LinkIcon = () => (
  ...
  >
    <path
      d="M16.19 8.23L14.77 9.65C13.99 10.43 13.99 11.7 14.77 12.48L16.19 13.9C16.97 14.68 18.24 14.68 19.02 13.9L20.44 12.48C21.22 11.7 21.22 10.43 20.44 9.65L19.02 8.23C18.24 7.45 16.97 7.45 16.19 8.23Z"
      stroke="#3558A2"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M7.81 15.77L9.23 14.35C10.01 13.57 10.01 12.3 9.23 11.52L7.81 10.1C7.03 9.32 5.76 9.32 4.98 10.1L3.56 11.52C2.78 12.3 2.78 13.57 3.56 14.35L4.98 15.77C5.76 16.55 7.03 16.55 7.81 15.77Z"
      stroke="#3558A2"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const LocationIcon = () => (
  ...
  >
    <path
      d="M21 10.5C21 17.5 12 23 12 23C12 23 3 17.5 3 10.5C3 6.35786 7.02944 3 12 3C16.9706 3 21 6.35786 21 10.5Z"
      stroke="#3558A2"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const TermsIcon = () => (
  ...
  >
    <path
      d="M9.11008 17.4L3.51008 11.8C2.73008 11.02 2.73008 9.75 3.51008 8.97L8.97008 3.51C9.75008 2.73 11.0201 2.73 11.8001 3.51L17.4001 9.11C18.1801 9.89 18.1801 11.16 17.4001 11.94L11.9401 17.4C11.1601 18.18 9.89008 18.18 9.11008 17.4Z"
      stroke="#3558A2"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const ImageIcon = () => (
  ...
  >
    ...
    />
    <path
      d="M9.35 11.04C10.7 11.04 11.79 9.95 11.79 8.6C11.79 7.25 10.7 6.16 9.35 6.16C8 6.16 6.91 7.25 6.91 8.6C6.91 9.95 8 11.04 9.35 11.04Z"
      stroke="#3558A2"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
    <path
      d="M2.66992 18.95L7.60992 15.64C8.38992 15.16 9.32992 15.17 10.0999 15.65L10.6899 16.07C11.5899 16.62 12.7299 16.62 13.6299 16.07L17.5499 13.73C18.4499 13.18 19.5899 13.18 20.4899 13.73L21.3299 14.27"
      stroke="#3558A2"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const RichTextToolbar = () => (
  <div className="flex items-center gap-x-3 border-b border-gray-200 px-3 py-2">
...
const CustomRadio = ({ fieldName, value, label, checked, onChange }) => (
  <label className="flex items-center gap-x-2 cursor-pointer text-sm text-gray-700">
    ...
    />
    <span
      className={`h-5 w-5 rounded-full border flex items-center justify-center ${checked ? "border-blue-600 bg-white" : "border-gray-400"}`}
    >
      {checked && (
  ...
  <div className="bg-white border border-gray-200/80 rounded-2xl shadow-sm p-6 mb-6">
    <div className="flex justify-between items-center mb-4">
      <div className="flex items-center gap-x-3">
        {icon}
        <h3 className="text-xl font-bold" style={{ color: "#3558A2" }}>
          {title}
        </h3>
      </div>
...
const PreviewField = ({ label, value }) => (
  <div>
    ...
    <p className="text-sm font-medium text-gray-800 mt-0.5 whitespace-pre-wrap">
      {value || "-"}
    </p>
  </div>
);
...
export default function RegistrationPage() {
  ...
  const applyDraft = () => {
    ...
    if (savedDraft) {
      ...
      if (parsedDraft.latitude && parsedDraft.longitude) {
        setMapPosition({
          lat: parseFloat(parsedDraft.latitude),
          lng: parseFloat(parsedDraft.longitude),
        });
      }
  ...
  const removeMenuItem = (category, id) => {
    const updatedMenus = { ...formData.menus };
    updatedMenus[category] = updatedMenus[category].filter(
      (item) => item.id !== id,
    );
    setFormData((prev) => ({ ...prev, menus: updatedMenus }));
  };
  ...
  useEffect(() => {
    const delayDebounceFn = setTimeout(() => {
      if (
        ...
        formData.locationDetail.trim().length > 3
      ) {
        handleSearchLocation(formData.locationDetail);
      } else {
        setSearchResults([]);
      ...
      <div className="relative w-full lg:w-1/3 h-64 lg:h-full flex-shrink-0">
        ...
        <div className="absolute bottom-0 left-0 p-8 text-white">
          ...
          <div className="flex flex-wrap gap-2">
            {" "}
            For
            {["Restaurant", "Hotel", "Bakery", "Cafe", "Bar", "Patisserie"].map(
              (tag) => (
                <span
                  key={tag}
                  className="px-4 py-1.5 text-sm border border-white/50 rounded-full bg-white/10"
                >
                  {tag}
                </span>
              ),
        ...
        <div className="flex-grow overflow-y-auto">
          <div className="p-6 sm:p-10 lg:p-16">
              ...
              <div className="flex items-center gap-x-2">
                {draftExists ? (
                  <>
                    <button
                      onClick={applyDraft}
                      className="px-4 py-2 border border-blue-300 rounded-lg text-blue-600 hover:bg-blue-50 text-sm font-medium"
                    >
                      Apply Draft
                    </button>
                    <button
                      onClick={deleteDraft}
                      className="px-4 py-2 border border-red-300 rounded-lg text-red-600 hover:bg-red-50 text-sm font-medium"
                    >
                      Delete Draft
                    </button>
                  </>
                  ...
                  <button
                    onClick={saveDraft}
                    className="flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg text-gray-600 hover:bg-gray-100 text-sm font-medium"
                  >
                    <SaveIcon />
                    Save as Draft
                  </button>
            ...
            <div className="w-full max-w-3xl mx-auto">
              <h2 className="text-3xl font-bold text-[#3558A2]">
                List your details
              </h2>
              <p className="text-[#656565] mt-2 mb-8">
                Please fill in all of the details of your restaurant.
              </p>
                ...
                <div className="flex justify-between items-center text-sm mb-2">
                  ...
                  <span className="text-gray-500">
                    ...
                    <span className="font-medium text-gray-700">
                      {nextStepData ? nextStepData.name : "Done!"}
                    </span>
                  </span>
                </div>
              ...
              <div className="mt-10">
                      ...
                      <div>
                        ...
                        <div className="border border-gray-300 rounded-lg overflow-hidden">
                          ...
                          <textarea
                            ...
                            onChange={handleInputChange}
                            className="w-full px-4 py-2 border-t-0 focus:ring-0 focus:outline-none"
                          ></textarea>
                        </div>
                      </div>
                    </div>
                      ...
                      {menuCategoriesData.map((cat) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="mt-4 text-sm font-medium text-blue-600 hover:text-blue-800 flex items-center gap-x-1 bg-blue-50 hover:bg-blue-100 px-3 py-2 rounded-lg"
                          >
                            <svg
                              className="w-4 h-4"
                              fill="none"
                                ...
                                <div className="flex items-center gap-x-2">
                                  ...
                                  {formData.logo && (
                                    <button
                                      type="button"
                                      onClick={() =>
                                        handleRemoveImage("logo", logoImageRef)
                                      }
                        ...
                        {(formData.galleryImages?.length || 0) > 0 && (
                          <div className="mt-4">
                            <p className="text-xs text-gray-600 mb-2">
                              Selected: {formData.galleryImages.length} image
                              {formData.galleryImages.length > 1 ? "s" : ""}
                            </p>
                    ...
                    <div className="space-y-8">
                      <div>
                        <div className="flex justify-between items-start">
                          <p className="text-sm font-medium text-gray-800">
                            Attend press conference and opening on Tuesday,
                            October 1, 2025 at IFI Thamrin?
                          </p>
                          {formData.terms_conference && <CheckIcon />}
                        </div>
                        <div className="mt-3 flex items-center gap-x-6">
                          <CustomRadio
                            fieldName="terms_conference"
                            value="yes"
                            label="Yes"
                            checked={formData.terms_conference === "yes"}
                            onChange={handleInputChange}
                          />
                          <CustomRadio
                            fieldName="terms_conference"
                            value="no"
                            label="No"
                            checked={formData.terms_conference === "no"}
                            onChange={handleInputChange}
                          />
                        </div>
                      </div>
                      <div>
                        <div className="flex justify-between items-start">
                          <div>
                            <p className="text-sm font-medium text-gray-800">
                              Interested in showcasing your menu during the
                              opening?
                            </p>
                            <p className="text-xs text-gray-500 mt-1">
                              Due to limited space, our team will follow up with
                              you.
                            </p>
                          </div>
                        ...
                        <div className="mt-3 flex items-center gap-x-6">
                          <CustomRadio
                            fieldName="terms_showcase"
                            value="yes"
                            label="Yes"
                            checked={formData.terms_showcase === "yes"}
                            onChange={handleInputChange}
                          />
                          <CustomRadio
                            fieldName="terms_showcase"
                            value="no"
                            label="No"
                            checked={formData.terms_showcase === "no"}
                            onChange={handleInputChange}
                          />
                        </div>
                      </div>
                      <div>
                        <div className="flex justify-between items-start">
                          <p className="text-sm font-medium text-gray-800">
                            Agree to the use of your photo, logo and dishes to
                        ...
                        <div className="mt-3 flex items-center gap-x-6">
                          <CustomRadio
                            fieldName="terms_publications"
                            value="yes"
                            label="Yes"
                            checked={formData.terms_publications === "yes"}
                            onChange={handleInputChange}
                          />
                          <CustomRadio
                            fieldName="terms_publications"
                            value="no"
                            label="No"
                            checked={formData.terms_publications === "no"}
                            onChange={handleInputChange}
                          />
                        </div>
                      </div>
                ...
                {currentStep === 8 && (
                  <div>
                          ...
                          <div key={cat.id}>
                            ...
                            <div className="space-y-3">
                              {items.map((item) => (
                                <div
                                  key={item.id}
                                  className="flex items-start gap-x-4 p-2 border-b last:border-b-0"
                                >
                                  {item.imageUrl && (
                                    <img
                                      src={item.imageUrl}
                                  ...
                                  <div className="flex-grow">
                                    ...
                                    {/*CREATE AN HELPER FUNCTION TO FORMAT CURRENCY*/}
                                  </div>
                                </div>
                              ))}
                            </div>
                    ...
                    >
                      {formData.logo && (
                        <PreviewField label="Logo" value={formData.logo.name} />
                      )}
                      {formData.coverImage && (
                        <PreviewField
                          label="Cover Image"
                          value={formData.coverImage.name}
                        />
                      )}
                      {formData.galleryImage && (
                        <PreviewField
                          label="Gallery Image"
                          value={formData.galleryImage.name}
                        />
                      )}
                      {formData.logo && (
                        <img
                    ...
                    >
                      <PreviewTerm
                        question="Attend press conference and opening on Tuesday, October 1, 2025 at IFI Thamrin?"
                        answer={formData.terms_conference}
                      />
                      <PreviewTerm
                        question="Interested in showcasing your menu during the opening?"
                        answer={formData.terms_showcase}
                      />
                      <PreviewTerm
                        question="Agree to the use of your photo, logo and dishes to be included in all publications? (Optional)"
                        answer={formData.terms_publications}
                      />
                    </PreviewSection>
                  </div>
                )}
